...
LumiLaboのIDEA BOARD / MOCKを作成・修正する場合や、Coding前にMOCK確認済み範囲を確認する場合は、共通の [Product Design Guide](../product-design/index.md) も参照する。通常の小修正、文言修正、画面を伴わないdocs修正では原則として読まない。
