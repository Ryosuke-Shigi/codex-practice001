...
- 共通UIと機能固有UIを分離する
- 背景・演出と操作UIを分離する
- デザイン参照画像は見た目の参考に限定し、実装仕様は明示された作業条件と既存docsを優先する
...
- デザイン参照画像は色味、光、密度、余白感などの参考に限定する
- デザイン参照画像内のUI、文言、Button、Cardを実装仕様と解釈しない
- 背景参照画像は背景だけ、UIなし、文字なしを基本とする
- 実装対象、成功条件、失敗条件、変更しない範囲は作業開始時に明示する
