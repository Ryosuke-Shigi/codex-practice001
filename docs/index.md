...
同じ内容に矛盾がある場合は、次の順序で確認します。

1. 現在のコード・Migration・設定と、成功しているテスト
2. `AGENTS.md` と共通方針docs
3. `docs/features/` の機能固有仕様
4. `README.md` の外部向け概要
5. Notion・GPT情報源・理解再起動用まとめ

下位の資料だけを根拠に、上位の内容を上書きしません。

コード・テスト・docsが矛盾している場合は、推測で進めず差異を報告します。
