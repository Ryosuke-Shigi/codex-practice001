    ...
    public function test_design_philosophy_page_renders_default_sections_from_config(): void
    {
        $this
            ...
            ->assertInertia(fn (Assert $page) => $page
                ...
                ->where('sections.0.title', '人間が判断し、AIは検証可能な境界で実行する。')
                ->where('sections.0.eyebrow', 'PORTFOLIO / CODEX ZERO TRUST')
                ...
                ->where('sections.4.title', 'Action - Domain - Responderで、責務と依存方向を描く。')
                ...
                ->where('sections.8.title', '実行可能であることを、実行してよいことへ変換しない。')
            );
    }
