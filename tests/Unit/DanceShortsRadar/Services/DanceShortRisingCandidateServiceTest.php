...
class DanceShortRisingCandidateServiceTest extends TestCase
{
    ...
    private function item(
        ...
        return new DanceShortVideoRankingItemDTO(
            ...
            likeCount: null,
            commentCount: null,
            currentCollectedAt: CarbonImmutable::parse($collectedAt, 'Asia/Tokyo'),
            previousCollectedAt: $previousViewCount === null ? null : CarbonImmutable::parse('2026-05-31 12:00:00', 'Asia/Tokyo'),
            comparisonDays: 1,
