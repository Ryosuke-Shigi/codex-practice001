...
function feedEntrySyncBadgeClassName(status: EarthquakeFeedEntrySyncStatus['status'] | null) {
    if (status === 'completed') {
                ...
                <section className="grid grid-cols-1 gap-3 xl:grid-cols-[minmax(0,0.85fr)_minmax(0,1.15fr)]">
                    <article className="rounded-lg border border-cyan-100/25 bg-cyan-100/8 p-5 shadow-[0_18px_40px_rgba(8,145,178,0.12)]">
                        <div className="flex flex-wrap items-start justify-between gap-3">
                            <div>
                                <span className={`inline-flex rounded-md border px-2.5 py-1 text-xs font-semibold ${feedEntrySyncBadgeClassName(latestVisibleSyncStatus?.status ?? null)}`}>
