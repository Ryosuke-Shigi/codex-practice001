...
export default function LumiLaboProjectIdeaBoard() {
    return (
        <PublicLayout
            className="h-dvh overflow-hidden bg-white px-3 py-3 text-black sm:px-4 lg:px-6"
            ...
            <div className="mx-auto flex h-full min-h-0 w-full max-w-7xl flex-col gap-3 overflow-hidden">
                <header className="flex flex-none items-center">
                    <Link
                        ...
                        className="inline-flex min-h-11 w-full items-center justify-center gap-2 rounded-lg border border-neutral-300 bg-white px-4 text-base font-semibold text-black shadow-sm shadow-neutral-900/10 transition hover:border-yellow-500 hover:bg-neutral-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-yellow-500 sm:w-fit"
                    >
