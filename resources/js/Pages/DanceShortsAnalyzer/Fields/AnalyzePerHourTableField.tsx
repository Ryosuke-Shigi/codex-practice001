...
export default function AnalyzePerHourTableField({
    table,
}: AnalyzePerHourTableFieldProps) {
    ...
    return (
        <section className="min-w-0">
            ...
            {!hasRows ? (
                <div className="rounded-lg border border-dashed border-white/14 bg-slate-950/50 px-3 py-4 text-xs font-semibold text-slate-200/76">
                    比較できるsnapshot区間がありません。
                </div>
            ) : (
