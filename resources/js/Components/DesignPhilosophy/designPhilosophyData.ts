...
export const subagents: SubagentDefinition[] = [
    ...
    { name: 'operations_specialist', group: 'implement', groupLabel: '実装・修正', roleLabel: 'Operations', description: '確認済みの既存構成に限り、運用構成の設計・実装・監査を担当します。' },
    ...
    { name: 'sol_specialist', group: 'implement', groupLabel: '実装・修正', roleLabel: '高難度実装', description: '複雑・曖昧・高リスク・複数レイヤーの問題を分析し、必要時だけ実装します。' },
